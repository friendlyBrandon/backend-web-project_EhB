<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto px-4 py-8">
        ...
        <form method="POST" action="{{ route('admin.faqs.store') }}" class="space-y-5">
            ...
            <div>
                <label for="category" class="block font-medium text-gray-900 dark:text-gray-100 mb-1">
                    Category
                </label>
                ...
                <select name="category" id="category"
                    ...
                    <option value="safe" {{ old('category') === 'safe' ? 'selected' : '' }}>
                        Staying Safe
                    </option>
            ...
            <div>
                <label for="question" class="block font-medium text-gray-900 dark:text-gray-100 mb-1">
                    Question
                </label>
            ...
            <div>
                <label for="answer" class="block font-medium text-gray-900 dark:text-gray-100 mb-1">
                    Answer
                </label>
